...
const CountdownSection: React.FC = () => {
  ...
  const CountdownUnit: React.FC<{ value: number; label: string }> = ({ value, label }) => (
    <div className="flex flex-col items-center">
      <div className="backdrop-blur-xl relative px-6 py-5 rounded-xl text-center min-w-[90px] md:min-w-[110px] bg-gradient-to-b from-white/10 to-white/5 border border-white/20 shadow-lg">
      ...
      <span className="text-sm mt-3 font-medium text-lockora-silver">{label}</span>
    </div>
  );

  return (
    <section id="countdown" className="py-24 relative overflow-hidden">
      ...
      <div className="container-padding mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          >
            <div className="inline-flex items-center justify-center py-1.5 px-4 rounded-full bg-gradient-to-r from-lockora-emerald/20 to-lockora-accent/20 text-sm font-medium text-lockora-emerald mb-6 border border-lockora-emerald/20">
            ...
            <p className="text-lockora-silver text-lg max-w-xl mx-auto">
        ...
        >
          <MouseParallax factor={0.01}>
            <div className="flex justify-center space-x-5 md:space-x-8 mb-16">
          ...
          <div className="flex justify-center mb-16">
            <div className="w-24 h-24 relative animate-float">
              ...
              <div className="relative w-full h-full bg-gradient-to-b from-white/15 to-white/5 backdrop-blur-xl rounded-xl border border-white/20 flex flex-col items-center justify-center overflow-hidden shadow-lg">
                <div className="bg-gradient-to-r from-lockora-emerald to-lockora-emerald/80 w-full py-2 text-xs text-white font-semibold">
          ...
          <div className="max-w-xl mx-auto bg-gradient-to-b from-white/10 to-transparent backdrop-blur-lg p-8 rounded-2xl border border-white/10 shadow-lg">
            <NewsletterSignup />
          </div>
          
          {/* Social Media Icons with improved design */}
          <div className="mt-16 text-center">
            <p className="text-lockora-silver mb-6 font-medium">Follow our journey</p>
            <div className="flex justify-center space-x-6">
              {['twitter', 'facebook', 'instagram', 'youtube'].map((platform) => (
                <a 
                  key={platform}
                  href="#" 
                  className="group relative w-12 h-12 flex items-center justify-center bg-gradient-to-b from-white/10 to-transparent rounded-full hover:from-lockora-emerald/20 hover:to-lockora-emerald/5 transition-all duration-300 border border-white/10"
                >
                  <span className="sr-only">{platform}</span>
                  {platform === 'twitter' && (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white group-hover:text-lockora-emerald transition-colors" viewBox="0 0 24 24" fill="currentColor">
